      ...
      <div className="flex-1 overflow-y-auto p-6 text-white thin-scroll">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 glass-panel p-6 h-[500px] flex items-center justify-center">
            <span className="text-text-muted font-bold tracking-widest uppercase animate-pulse">Gathering Semiconductor Telemetry...</span>
          </div>
          <div className="glass-panel p-6 h-[500px] flex items-center justify-center">
            <span className="text-text-muted font-bold tracking-widest uppercase animate-pulse">Loading Tech Feed...</span>
          </div>
        </div>
      </div>
    </div>
